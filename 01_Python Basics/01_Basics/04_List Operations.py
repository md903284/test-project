...
n=[90,20,30,56,76,88,90,100]
print(list(n))


print("large number in list:",max(n))
print("small number in list:",min(n))
print("sum of all number in list:",sum(n))
print("Reverse order in list:",n[::-1])
